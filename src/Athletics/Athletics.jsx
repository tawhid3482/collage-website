...
const Athletics = () => {
  return (
    <div className="p-7">
      ...
      <div className="">
        <Banner img={'https://eliteclubs.com/wp-content/uploads/2019/11/The-Pros-Cons-of-Exercising-with-a-Friend-e1571837163735.jpeg'} title={'Our goal is to be at the heart of the financial services industry as businesses expand across.'} subTitle={''}></Banner>
      </div>
      <div className="">
       <Sponser></Sponser>
      </div>
