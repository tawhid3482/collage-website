    ...
    return (
        <div className="my-10">
            <div className="flex-col lg:flex-row lg:flex justify-between items-center gap-16">
                ...
                <div className="lg:w-1/2">
                <hr className="border-2 border-green-500 w-full my-5" />
                ...
                <div className="my-5 ">
                <button className="btn bg-green-500 text-lg text-white">Athletics guide book <FaBook className="text-xl"></FaBook></button>
                </div>
                </div>
            </div>
        </div>
