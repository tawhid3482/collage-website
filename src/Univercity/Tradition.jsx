  ...
  return (
    <div className="">
      ...
      <div className="lg:w-1/2 p-8 bg-gray-200">
        <img src="https://us.123rf.com/450wm/visoot/visoot2306/visoot230602584/207333551-bus-luxury-vip-first-class-travel-vacation-tourism-tour-public-route-modern-art-design-vector.jpg" className="w-full" alt="" />
        <div className="flex gap-5 my-5 items-center">
            <FaBus className="text-4xl "></FaBus>
            <p className="text-xl font-bold">Transportations</p>
        </div>
        <div className="">
            <p className="text-xl font-bold my-5">There are many options to travel in the campus.</p>
        ...
        <p>More than 1000 parking lots avilable in the west side of the compus. The parking is available 24 hours with 24hours security. We make sure that everything is under control.</p>
      </div>
      </div>
    </div>
  );
